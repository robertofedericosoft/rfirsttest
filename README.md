...
Jupyter+R: [![Binder](http://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/robertofedericosoft/rfirsttest/HEAD?filepath=index.ipynb)

RStudio: [![Binder](http://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/robertofedericosoft/rfirsttest/HEAD?urlpath=rstudio)

RShiny: [![Binder](http://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/robertofedericosoft/rfirsttest/HEAD?urlpath=shiny/bus-dashboard/)

MyBinder: [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/robertofedericosoft/rfirsttest/HEAD)
